...
# Execute the next scope in line
/ship
```
...
Stacks of scopes. The binary writes scopes into `.stax/`, and the two skills move them along the line: `/scope` files a new scope, `/ship` works the stack.
