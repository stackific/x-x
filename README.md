...
[![Latest Release](https://img.shields.io/github/v/tag/stackific/stax?sort=semver&label=release)](https://github.com/stackific/stax/releases/latest)
...
# Launch the UI for the project explorer
stax
```
