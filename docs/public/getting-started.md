...
$ stax init        # installs bundled skills into ~/.claude/skills, ~/.cursor/skills, ~/.gemini/antigravity-cli/skills, ~/.gemini/config/skills, ~/.kilocode/skills, ~/.opencode/commands, ~/.agents/skills (or project-local)
```
