...
$ x-x init        # installs bundled skills into ~/.claude/skills, ~/.cline/skills, ~/.continue/skills, ~/.cursor/skills, ~/.kilocode/skills, ~/.gemini/antigravity/skills, ~/.opencode/commands, ~/.agents/skills (or project-local)
```
