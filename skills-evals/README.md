...
3. Scores the produced work-item file with a DeepEval `GEval` judge.
...
│   ├── workspace.py                     # collects work-item/produced artifacts as text
│   ├── models.py                        # DeepSeek wrapper for DeepEval
│   └── judges/
│       ├── base.py                      # Judge ABC + Judgment dataclass
│       ├── plan_judge.py                # GEval on the work-item file
