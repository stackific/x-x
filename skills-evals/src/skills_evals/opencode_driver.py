...
#
#   2. Destructive overwrites in the executor. When `ship` runs a work item
#      whose system already has an existing artifact (e.g. a reminders
#      work item that supersedes a todo work item, with the todo's index.html
#      already on disk), the model emits a checkpoint message like
#      "FYI: I'll review the whole work item with you at once" and goes
