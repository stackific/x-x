...
#
#   2. Destructive-overwrite checkpoints in /ship — when a work item would
#      replace an existing artifact (e.g. reminders.html on top of
#      todo.html), the model emits a meta-message ("FYI: I'll review
#      the whole work item with you at once") and goes idle waiting for
...
def _detect_stream_error(events: list[dict]) -> str | None:
  ...
  cryptic "got 0 work-item files" — masking the upstream cause.
  """
