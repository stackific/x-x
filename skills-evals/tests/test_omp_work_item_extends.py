...
Mirror of test_claude_work_item_extends.py against the omp driver. Per
agents/skills/scope/SKILL.md step 2a + step 3, when a new work item
...
def test_omp_work_item_extends(workspace: Path, tmp_path: Path) -> None:
