...
"""End-to-end: drive Pi through plan-supersede + artifact-replace.
...
def test_pi_reminders_supersedes_todo(
  ...
  assert todo_run.exit_code == 0, (
    f"pi exited {todo_run.exit_code} during /x-plan todo; "
  ...
  assert reminders_run.exit_code == 0, (
    f"pi exited {reminders_run.exit_code} during /x-plan reminders; "
